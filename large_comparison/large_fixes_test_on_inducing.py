...
MODEL_NAME = 'small_10folds_fixes_fold0'
CLASSIFIER_NAME = 'rf_classifier_small_10folds_fixes_fold0.pkl'
...
def get_sequence_pairs(path_csv, train_path_csv):
    ...
    #training pairs
    df_csv = pd.read_csv(train_path_csv)
    text_pairs = []
    for index_df_csv in df_csv.index:
...
text_pairs, test_pairs, MAX_SEQUENCE_LENGTH, INP_VOCAB_SIZE, OUT_VOCAB_SIZE = get_sequence_pairs(PATH_CSV, TROVON_PATH_CSV)
